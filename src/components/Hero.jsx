...
// // // //       {/* Main Content */}
// // // //       <div className="flex-1 flex flex-col items-center justify-center px-6 lg:px-12 pb-4 lg:pb-8 gap-3 lg:gap-4">
// // // //         {/* Image Container - Reduced height */}
// // // //         <div 
// // // //           className="w-[85vw] lg:w-[50vw] max-w-[700px] h-[22vh] lg:h-[24vh] relative opacity-0" 
// // // //           style={{animation: 'fadeInUp 1s ease 0.3s forwards'}}
// // // //         >
// // // //           <div className="w-full h-full rounded-lg   shadow-[0_20px_60px_rgba(0,0,0,0.15)] relative bg-gradient-to-br from-[#667eea] to-[#764ba2]">
// // // //             <div className="w-full h-full flex items-center justify-center relative  ">
// // // //               <div className="w-[70%] h-[70%] bg-[#2a2a2a] rounded-lg p-1.5 lg:p-2 shadow-[0_10px_40px_rgba(0,0,0,0.3)] flex items-center justify-center relative">
// // // //                 <div className="w-full h-full bg-white rounded flex items-center justify-center text-lg lg:text-2xl text-[#1a1a1a] font-semibold" style={{fontFamily: "'Playfair Display', serif"}}>
// // // //                   Portfolio Preview
// // // //                 </div>
// // // //               </div>
// // // //             </div>
...
// // // //         <h2 
// // // //           className="text-2xl lg:text-3xl font-normal text-center leading-relaxed text-[#1a1a1a] max-w-3xl opacity-0" 
// // // //           style={{
// // // //             fontFamily: "'Playfair Display', serif",
// // // //             animation: 'fadeInUp 1s ease 0.5s forwards'
// // // //           }}
// // // //         >
// // // //           Crafting <strong className="font-['playfairdisplay']">digital experiences</strong>
// // // //           <br />
// // // //           that inspire and engage.
// // // //         </h2>

// // // //         {/* Name Title - Reduced size to fit */}
// // // //         <h1 
// // // //           className="font-['Brixton'] font-black text-[14vw] lg:text-[22vw] uppercase tracking-tighter text-[#1a1a1a] text-balance leading-[0.85] mt-auto opacity-0 w-full" 
...
// // // //               style={{
// // // //                 animation: isMenuOpen ? `menuItemFadeIn 0.6s ease ${0.1 * (index + 1)}s forwards` : 'none'
// // // //               }}
// // // //             >
// // // //               {item}
// // // //             </div>
...
// // //       // Name split animation - DEEPAK from left, ZAMNANI from right
...
// // //           // Image and tagline fade out and scale down
...
// // //   return (
// // //     <>
// // //       <div ref={heroRef} className="h-screen w-screen bg-[#f5f5f0] relative">
// // //         <div className="h-screen w-screen flex flex-col sticky top-0  ">
// // //           {/* Dotted Line Decoration */}
// // //           <div 
// // //             ref={decorLineRef}
...
// // //             <div 
// // //               ref={imageRef}
// // //               className="w-[85vw] lg:w-[50vw] max-w-[700px] h-[22vh] lg:h-[24vh] relative"
// // //             >
// // //               <div className="image-inner w-full h-full rounded-lg   shadow-[0_20px_60px_rgba(0,0,0,0.15)] relative bg-gradient-to-br from-[#667eea] to-[#764ba2]">
// // //                 <div className="w-full h-full flex items-center justify-center relative  ">
// // //                   <div className="w-[70%] h-[70%] bg-[#2a2a2a] rounded-lg p-1.5 lg:p-2 shadow-[0_10px_40px_rgba(0,0,0,0.3)] flex items-center justify-center relative">
// // //                     <div className="w-full h-full bg-white rounded flex items-center justify-center text-lg lg:text-2xl text-[#1a1a1a] font-semibold" style={{fontFamily: "'Playfair Display', serif"}}>
// // //                       Portfolio Preview
...
// // //             <h2 
// // //               ref={taglineRef}
// // //               className="text-2xl lg:text-3xl font-normal text-center leading-relaxed text-[#1a1a1a] max-w-3xl" 
...
// // //             {/* Name Title - Split into two parts */}
// // //             <div className="mt-auto w-full  ">
// // //               <h1 className="font-['Brixton'] font-black text-[14vw] lg:text-[22vw] uppercase tracking-tighter text-[#1a1a1a] leading-[0.85] text-center">
...
// // //         {/* Content after hero for scroll demo */}
// // //         {/* <div className="h-screen bg-gradient-to-b from-[#f5f5f0] to-[#e5e5df] flex items-center justify-center">
// // //           <div className="text-center">
// // //             <h2 className="text-4xl lg:text-6xl font-bold text-[#1a1a1a] mb-4">Next Section</h2>
// // //             <p className="text-lg text-[#1a1a1a] opacity-70">Scroll back up to see the animation again</p>
// // //           </div>
// // //         </div> */}
// // //       </div>
...
// //       // About section animations - triggered after name animation
...
// //   return (
// //     <>
// //       <div ref={heroRef} className="min-h-[200vh] w-screen bg-[#f5f5f0] relative">
// //         <div className="h-max w-screen flex flex-col sticky top-0">
// //           {/* Dotted Line Decoration */}
// //           <div 
// //             ref={decorLineRef}
// //             className="absolute left-0 right-0 top-20 h-px" 
...
// //             {/* About Section - Extended Hero */}
// //             <div className="w-full max-w-4xl mx-auto text-center space-y-6 lg:space-y-8 pb-12 lg:pb-16">
// //               {/* About Label */}
...
// //               <h2 
// //                 ref={aboutTitleRef}
// //                 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-normal leading-tight text-[#1a1a1a]"
// //                 style={{fontFamily: "'Playfair Display', serif"}}
// //               >
...
// //               {/* Learn More Button with Dotted Lines */}
...
//       // Scroll-triggered exit animations for hero
//       ScrollTrigger.create({
//         trigger: heroRef.current,
//         start: 'top top',
//         end: 'bottom top',
...
//       // Works header animation - scroll triggered
...
//       // Projects section animations - scroll triggered
...
//       // View All button - scroll triggered
...
//           <div 
//             ref={decorLineRef}
//             className="absolute left-0 right-0 top-20 h-px z-10" 
//             style={{
//               backgroundImage: 'repeating-linear-gradient(to right, #1a1a1a, #1a1a1a 4px, transparent 4px, transparent 8px)',
//             }}
//           />
...
//       {/* Featured Works Section - Separate from Hero */}
//       <div className="h-max w-screen bg-[#f5f5f0] py-20 lg:py-32">
//         {/* Works Header */}
//         <div ref={worksHeaderRef} className="w-full max-w-7xl mx-auto px-8 lg:px-16 mb-16 lg:mb-20">
//           <div className="flex items-center justify-between">
//             <div className="header-line flex-1 h-px bg-[#1a1a1a] opacity-30"></div>
            
//             <div className="px-8 lg:px-12">
//               <span 
//                 className="script-text text-xl lg:text-2xl opacity-70 text-[#1a1a1a]"
...
//               <h1 
//                 className="works-text text-6xl lg:text-8xl xl:text-9xl font-black tracking-tighter text-[#1a1a1a]"
//                 style={{ 
...
//                 WORKS
//               </h1>
//               <span className="header-star text-3xl lg:text-5xl opacity-50 text-[#1a1a1a]">✦</span>
//             </div>
//           </div>
//         </div>

//         {/* Featured Projects */}
//         <div ref={projectsSectionRef} className="w-full max-w-7xl mx-auto px-8 lg:px-16 space-y-32 mb-20">
...
//                       <button 
//                         className="text-white px-8 py-3 text-xs font-bold tracking-[0.2em] uppercase rounded-full shadow-lg transition-all duration-300 hover:scale-105 border-none cursor-pointer"
...
//                     <span className="text-lg lg:text-xl font-bold" style={{ color: project.color }}>{project.year}</span>
//                     <div className="year-line flex-1 h-px opacity-30" style={{ backgroundColor: project.color }}></div>
//                     <span className="text-lg lg:text-xl font-bold" style={{ color: project.color }}>{project.year}</span>
//                   </div>
...
//                   <p className="text-sm lg:text-base font-semibold tracking-wide leading-relaxed mb-8" style={{ color: project.color }}>
//                     {project.description}
//                   </p>

//                   <p className="text-[#1a1a1a] opacity-60 text-xs lg:text-sm tracking-wide mb-8">
...
//                       <span 
//                         key={tag}
//                         className="project-tag px-4 py-1.5 bg-transparent text-xs tracking-wider rounded-full"
//                         style={{ 
...
export default function Hero({ onNavigateToProjects }) {
  ...
  return (
    <>
      ...
      {/* Featured Works Section - Separate from Hero */}
      <div className="min-h-max w-screen bg-[#f5f5f0] py-20 lg:py-32">
        {/* Works Header - Centered Design */}
        ...
        {/* Featured Projects - Card Grid Style */}
        <div ref={projectsSectionRef} className="w-full max-w-7xl mx-auto px-8 lg:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 mb-20">
            {featuredProjects.map((project, index) => (
              ...
              >
                {/* Card Container */}
                <div className="relative bg-white rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.08)] overflow-hidden transition-all duration-500 hover:shadow-[0_30px_80px_rgba(0,0,0,0.15)] hover:-translate-y-2">
